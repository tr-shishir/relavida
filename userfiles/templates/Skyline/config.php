...
// $config['stylesheet_compiler']['settings']['default'] = array('type' => 'color', 'default' => '#333', 'label' => 'Default color');
...
$config['stylesheet_compiler']['settings']['submenuColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Submenu Color');
$config['stylesheet_compiler']['settings']['submenuItemHoverBg'] = array('type' => 'color', 'default' => '#969696', 'label' => 'Sub Menu Hover Background');
$config['stylesheet_compiler']['settings']['submenuHoverColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Submenu Hover Color');
...
$config['stylesheet_compiler']['settings']['categoryBgColor'] = array('type' => 'color', 'default' => '#e6e6e6', 'label' => 'Background Color');
...
$config['stylesheet_compiler']['settings']['searchBoxBg'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Search Box Background');
...
$config['stylesheet_compiler']['settings']['allFontColor'] = array('type' => 'color', 'default' => '#000', 'label' => 'Font color for everything except product text');
$config['stylesheet_compiler']['settings']['productTextFontColor'] = array('type' => 'color', 'default' => '#000', 'label' => 'Font color for Product texts');
...
$config['template_settings'][] = array('type' => 'title', 'label' => ' ');
