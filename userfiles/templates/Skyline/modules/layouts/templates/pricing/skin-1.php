...
<section class="section section-pricing <?php echo $layout_classes; ?> edit safe-mode nodrop" field="layout-pricing-skin-1-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="row pricing-list-new d-flex justify-content-center">
