...
<a href="<?php if (!in_live_edit()) {
    ...
    <?php if ($logoimage == '' and $text == '') {
        ...
        <?php if ($logotype == 'image' or $logotype == false or $logotype == 'both') { ?><?php if($logoimage != '' and $logoimage != false){ ?><span class="mw-ui-col" style="width: <?php print $size; ?>;max-width:150px !important;">
