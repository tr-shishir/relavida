...
<style>
    ...
    #main-navigation li.depth-0,
    #main-navigation .list > li{
        display: inline-block;
    }
    #main-navigation .navbar_hover ul > li:hover > ul {
        display: block !important;
    }
    .navbar_hover ul > li > a{
        width: 100%;
    }
    .custom_hover_menu span.expandCat {
        display: none !important;
    }
    #main-navigation .dropdown.hasSubMenu > ul li {
        display: block !important;
    }
    .navbar_hover .dropdown-toggle::after {
        margin-top: 8px;
    }
...
?>
<div id="header-menu">
    <div class="add_more_nav custom_hover_menu navbar_hover navbar_new">
        <?php
            if ($mt != false) {
                print ($mt);
            } else {
