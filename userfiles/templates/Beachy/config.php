...
$config['stylesheet_compiler']['settings']['menuFontColor'] = array('type' => 'color', 'default' => '#212121', 'label' => 'Font Color');
$config['stylesheet_compiler']['settings']['menuFontHoverColor'] = array('type' => 'color', 'default' => '#0044de', 'label' => 'Hover And Active Color');
...
$config['stylesheet_compiler']['settings'][] = array('type' => 'delimiter');
$config['stylesheet_compiler']['settings']['subMenuBg'] = array('type' => 'color', 'default' => '#212121', 'label' => 'Sub Menu Background');
$config['stylesheet_compiler']['settings']['subMenuColor'] = array('type' => 'color', 'default' => '#f4f4f4', 'label' => 'Sub Menu Color');
$config['stylesheet_compiler']['settings']['subMenuHoverBg'] = array('type' => 'color', 'default' => '#282828', 'label' => 'Sub Menu Hover Background');
$config['stylesheet_compiler']['settings']['subMenuHoverColor'] = array('type' => 'color', 'default' => '#CBCBCB', 'label' => 'Sub Menu Hover Color');
...
$config['stylesheet_compiler']['settings']['searchBoxBg'] = array('type' => 'color', 'default' => '#212121', 'label' => 'Search Box Background');
...
$config['stylesheet_compiler']['settings']['searchButtonBg'] = array('type' => 'color', 'default' => '#4592ff', 'label' => 'Search Button Background');
