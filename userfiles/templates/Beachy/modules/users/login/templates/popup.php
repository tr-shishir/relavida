...
<?php else: ?>
    ...
    <div id="user_login_holder_<?php print $params['id'] ?>">
        ...
        <p>Wenn Sie bereits ein Kundenkonto bei uns haben, <br/>können Sie sich jetzt anmelden.<br/><br/></p>
        ...
        <form method="post" id="user_login_<?php print $params['id'] ?>" action="#" autocomplete="off">
            ...
            <div class="login-modal-wrapper">
                <div class="remember-btn">
                    <div class="form-group">
                        <label class="styled-checkbox"> Zugangsdaten speichern
                ...
                <div class="forgot-btn">
                    <p class="forgetPass-text"><a href="<?php print forgot_password_url(); ?>">Passwort vergessen ?</a></p>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-default btn-lg btn-block m-t-10"><?php _e("Einloggen"); ?></button>
        </form>
        ...
        <div class="act create">
            <a href="<?php print register_url(); ?>" class="js-show-register-window"><span>Einen neuen Account erstellen<i class="fa fa-forward" style="margin-left: 10px;" aria-hidden="true"></i></span></a>
        </div>
    </div>
<?php endif; ?>
