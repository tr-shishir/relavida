...
*/
?>
<link rel="stylesheet" href="<?php print template_url(); ?>modules/shop/products-style.css" type="text/css"/>
<?php
                            ...
                            <div class="col-12 product-checkout-button">
                                <div class="" style="margin-bottom:8px">
                                    ...
                                    <?php elseif(isset($item['price']) && !(floatval($item['price']) > 0)): ?>
                                        <button title="<?php _e('Price On Request'); ?>" onclick="priceModal(); price_on_request_product_id_get(<?php print $item['content_id']; ?>,'<?php print $item['title']; ?>');"   class="btn btn-primary product-cart-icon price-on-request-btn" ><?php _e('Price On Request'); ?></button>
                                    <?php else: ?>
