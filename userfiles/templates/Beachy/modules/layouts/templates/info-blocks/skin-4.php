                ...
                <div class="row">
                    <div class="order-2 order-xl-1 text-center text-sm-center text-lg-left col-md-10 mx-auto col-lg-7 m-b-20 d-flex flex-column justify-content-center align-items-center">
                        <div class="allow-drop">
                            <h1 class="m-b-30">Making the web a better place with Droptienda</h1>
                            <p>Droptiendas is an open-source content management system and website builder. It is based on the PHP programming language and the Laravel 5 web application framework, using drag and drop and allowing users to quickly create content, while scheduling and managing multiple
                                displays.</p>
