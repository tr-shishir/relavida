...
<style>
    ...
    @media (min-width: 1000px){
        #header_menu li>ul li a.dropdown-toggle::after {
    ...
    #header_menu .menu-with-description li ul li {
        width: auto;
        margin-bottom: 10px;
    }

    #header_menu .menu-with-description li>ul li a.dropdown-toggle::after {
        position: absolute !important;
        top: 0;
        right: 5px !important;
    }

    #header_menu .menu-with-description li ul li>ul{
        left: 104% !important;
    }

    #header_menu .menu-with-description ul li ul li>a {
        color: #fff;
        min-width: 250px;
        max-width: 250px;
    }
    ...
    #header_menu .menu-with-description ul li ul li>a:hover {
    ...
    .menu-with-description li.dropdown.has-sub-menu {
        position: unset;
    }

    .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu {
        width: 83%;
        right: 50%;
    ...
    .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li {
        width: 25% !important;
        display: inline-block;
    }

    #header_menu .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li ul.dropdown-menu {
    ...
    #header_menu .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li ul.dropdown-menu li {
        width: 100% !important;
    }
    #header_menu .menu-with-description ul li ul li>a {
    ...
    #header_menu .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li ul.dropdown-menu li:last-child {
        margin-bottom: 0;
    }
</style>
<?php
