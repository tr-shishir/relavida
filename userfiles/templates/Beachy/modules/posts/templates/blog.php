            ...
            <div class="row new-world-news">
                <?php if (!empty($data)): ?>
                    ...
                    <?php foreach ($data as $key => $item):
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-4 <?php if ($key == 2 AND is_array($data) AND count($data) == 3): ?>d-block d-md-none d-lg-block<?php endif; ?>" <?php if(is_live_edit()): ?>no-<?php endif;?> itemscope itemtype="<?php print $schema_org_item_type_tag ?>">
                            <div class="post-holder">
                                <a href="<?php ($item['is_rss'] == 1) ? print $item['rss_link'] : print $item['link'] ?>" itemprop="url">
                                    <div class="thumbnail-holder">
                                        ...
                                        <?php if (!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)): ?>
                                            <div class="thumbnail" style="background: url('<?php ($item['is_rss'] == 1) ? print $item['rss_image'] : print thumbnail($item['image'], 535, 285, true); ?>')">
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </a>
                                ...
                                <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                                    <div class="blog-post-title">
                                        <a href="<?php ($item['is_rss'] == 1) ? print $item['rss_link'] : print $item['link'] ?>">
                                            ...
                                            <h3 class="m-b-10 post-title"><?php print $blog_titile; ?></h3>
                                        </a>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if (!isset($show_fields) or $show_fields == false or in_array('read_more', $show_fields)): ?>
                                    <a href="<?php ($item['is_rss'] == 1) ? print $item['rss_link'] : print $item['link'] ?>" itemprop="url" class="button-8 m-t-20"><span><?php (get_option('data-read-more-text')!=null) ? print get_option('data-read-more-text') : print "Bericht lesen"?></span></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
