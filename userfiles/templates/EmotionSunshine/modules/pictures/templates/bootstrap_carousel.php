...
<?php $rand = 'item_carousel_'.$params['id']; $id = 'carousel_'.$params['id']; ?>
    ...
    <!-- Carousel nav -->
      <a class="carousel-control left" href="#<?php print $id; ?>" data-slide="prev"><span class="material-icons">
arrow_back_ios
</span></a>
      <a class="carousel-control right" href="#<?php print $id; ?>" data-slide="next"><span class="material-icons">
arrow_forward_ios
</span></a>
    </div>
    </div>
