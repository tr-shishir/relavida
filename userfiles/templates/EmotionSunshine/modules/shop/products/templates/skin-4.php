...
?>
    ...
    <style>
        @media screen and (min-width: 991px) {
            .single-wrapper .single-product .product-description {
                min-height: 189px;
                position: relative;
            }
        }
    </style>
    <section id="shop-product-all" class="swc-resp">
        <div class="row shop-products">
            ...
            ?>
                ...
                <div class="single-wrapper prod-with-cat item-<?php print $item['content_id'] ?>" data-masonry-filter="<?php //print $itemCats;
    ...
    <script type="text/javascript">
        <?php if ($is_logged && !isset($_GET['slug']) && !isset($_GET['wishlist_id']) && !isset($_GET['slug']) && !isset($_GET['wishlist_id'])) { ?>
