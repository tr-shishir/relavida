...
<section class="section sec-padd-50 edit safe-mode nodrop <?php print $cards_module_shadow; ?>" field="layout-skin-19-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="row blog-posts blog-posts-skin-19">

                    <div class="card-modules-skin-19-single m-b-40 col-12 col-md-6 col-lg-4 cloneable">
                        <a href="javascript:;">
                            <div class="post">
