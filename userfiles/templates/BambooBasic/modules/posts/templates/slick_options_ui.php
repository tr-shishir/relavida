...
<div class="mw-flex-row slider-options">
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label">, "templates/bamboo"<?php _lang("Pager", "templates/bamboo"); ?></label>
            <select name="pager" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pager == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($pager == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Controls", "templates/bamboo"); ?></label>
            <select name="controls" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($controls == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($controls == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Loop", "templates/bamboo"); ?></label>
            <select name="loop" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($loop == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($loop == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Adaptive Height", "templates/bamboo"); ?></label>
            <select name="adaptive_height" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($adaptiveHeight == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($adaptiveHeight == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Autoplay Speed", "templates/bamboo"); ?></label>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Pause on hover", "templates/bamboo"); ?></label>
            <select name="pause_on_hover" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pauseOnHover == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($pauseOnHover == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Autoplay", "templates/bamboo"); ?></label>
            <select name="autoplay" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($autoplay == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($autoplay == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Draggable", "templates/bamboo"); ?></label>
            <select name="draggable" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($draggable == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($draggable == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Fade", "templates/bamboo"); ?>
            ...
            <select name="fade" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($fade == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($fade == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Focus On Select", "templates/bamboo"); ?></label>
            <select name="focus_on_select" class="mw-ui-field mw_option_field mw-full-width" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($focusOnSelect == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/bamboo"); ?></option>
                <option value="true" <?php if ($focusOnSelect == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/bamboo"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            <label class="mw-ui-label"><?php _lang("Center Padding", "templates/bamboo"); ?></label>
