...
<div class="product-slider slider-new-layout">
    <div class="slickSlider">
        <?php foreach ($data as $slide) { ?>
            <div class="slide">
                <div class="holder" style="background:url('<?php print thumbnail($slide['images'][0], $thumb_quality_x, $thumb_quality_y); ?>');">
                    <?php if (isset($slide['url'])): ?><a href="<?php print $slide['url']; ?>"><?php endif; ?>
                        <!-- <img style="width:100%;" src="<?php print thumbnail($slide['images'][0], $thumb_quality_x, $thumb_quality_y); ?>"/> -->
                        <?php if (isset($slide['url'])): ?></a><?php endif; ?>
                </div>
                <div class="slider-content">
                    <h2><?php echo $slide['primaryText']; ?></h2>
