...
<div data-parallax="" data-overlay="1" data-overlay-black="" class="edit safe-mode nodrop" field="layout-skin-17-<?php print $params['id'] ?>" rel="module">
    <section class="section-3 inverse h-half d-flex background-image-holder">
        <div class="container align-self-center">
            <div class="row">
                <div class="col-12 allow-drop">
                    <h5 class="fx-deactivate"><?php print _lang('Online Store', 'templates/bamboo'); ?></h5>
                    <h2 class="fx-deactivate"><?php print _lang('Bamboo', 'templates/bamboo'); ?></h2>
                </div>
            </div>
        </div>
    </section>
