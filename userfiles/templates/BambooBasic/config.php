...
$config['stylesheet_compiler']['settings']['primary'] = array('type' => 'color', 'default' => '#007bff', 'label' => 'Primary color');



// Menu Options
$config['stylesheet_compiler']['settings'][] = array('type' => 'title', 'label' => 'Menu Options');
$config['stylesheet_compiler']['settings']['menuFontColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Font Color');
$config['stylesheet_compiler']['settings']['menuFontHoverColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Hover And Active Color');

$config['stylesheet_compiler']['settings']['submenuContainerBackground'] = array('type' => 'color', 'default' => '#222', 'label' => 'Submenu Background');
$config['stylesheet_compiler']['settings']['submenuColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Submenu Color');
$config['stylesheet_compiler']['settings']['submenuItemHoverBg'] = array('type' => 'color', 'default' => '#969696', 'label' => 'Sub Menu Hover Background');
$config['stylesheet_compiler']['settings']['submenuItemHoverColor'] = array('type' => 'color', 'default' => '#000', 'label' => 'Sub Menu Hover Color');
$config['stylesheet_compiler']['settings']['menuFontSize'] = array('type' => 'text', 'default' => '20px', 'label' => 'Font Size');
...
$config['stylesheet_compiler']['settings']['footerMenuColor'] = array('type' => 'color', 'default' => '#f3f3f3', 'label' => 'Footer Menu Color');
$config['stylesheet_compiler']['settings']['footerMenuHoverColor'] = array('type' => 'color', 'default' => '#fff', 'label' => 'Footer Menu Hover Color');

$config['stylesheet_compiler']['settings'][] = array('type' => 'delimiter');

// Category Options
$config['template_settings'][] = array('type' => 'title', 'label' => 'Category Options');
$config['stylesheet_compiler']['settings']['categoryFontColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Font Color');
$config['stylesheet_compiler']['settings']['categoryFontHoverColor'] = array('type' => 'color', 'default' => '#222', 'label' => 'Hover And Active Color');

$config['stylesheet_compiler']['settings'][] = array('type' => 'delimiter');

$config['stylesheet_compiler']['settings'][] = array('type' => 'title', 'label' => 'Search Box colors');
$config['stylesheet_compiler']['settings']['searchBoxBg'] = array('type' => 'color', 'default' => '#222', 'label' => 'Search Box Background');
$config['stylesheet_compiler']['settings']['searchInputFieldBg'] = array('type' => 'color', 'default' => '#555555', 'label' => 'Search Input Field Background');
...
$config['stylesheet_compiler']['settings']['headerButtonBgColor'] = array('type' => 'color', 'default' => '#000', 'label' => 'Header Button Background Color');
