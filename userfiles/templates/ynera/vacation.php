...
<head>
    ...
    <link rel="stylesheet" href="<?php print template_url(); ?>assets/css/material_icons/material_icons.css"
        type="text/css" />
...
<body>
            ...
            <div class="vacation-wrapper-col">
                ...
                <div class="vacation-wrapper-content">
                    ...
                    <div class="vacation-wrapper-content-date">
                        <p><strong><?php _e('Start Date'); ?>:</strong>
                            <span><?php  print date('Y-m-d',strtotime($vacation_start_date)); ?></span></p>
                        <p><strong><?php _e('End Date'); ?>:</strong>
                            <span><?php  print date('Y-m-d',strtotime($vacation_end_date)); ?></span></p>
                    </div>
    ...
    $("body").mousemove(function(event) {
        if ($('#mw-dialog-holder-module-settings-header-menu').length > 0) {
            $("#mw-dialog-holder-module-settings-header-menu .mw-dialog-header").mouseenter(function() {
                ...
                $('#mw-dialog-holder-module-settings-header-menu .closeandReload').on('click',
                function() {
                    location.reload();
                });
            });
    ...
    <script type="text/javascript" src="<?php print template_url(); ?>assets/plugins/masonry/masonry.pkgd.min.js">
    </script>
    <script type="text/javascript" src="<?php print template_url(); ?>assets/plugins/masonry/isotope.pkgd.min.js">
    </script>
