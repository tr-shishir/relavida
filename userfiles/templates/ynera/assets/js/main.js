(function () {
    ...
    var qTheme = {
        ...
        stickyNav: function () {
            $("body.sticky-nav .navigation")[$window.scrollTop() ? "addClass" : "removeClass"](
                "sticky"
            );
        },
    };
    ...
    $document.ready(function () {
        ...
        var eGalleryMobile = $("#elevatezoom-gallery.mobile-view");
        ...
        if (eGalleryMobile.length > 0) {
            eGalleryMobile.each(function () {
                var ell = $(this);
                ell.slick({
                    centerMode: true,
                    centerPadding: "0",
    ...
    function setPaddingToSections() {
        if ($window.width() > 991) {
            ...
            $(".section-8").each(function () {
                ...
                leftSide.css({
                    "padding-left": (headerWidth - headerContainerWidth) / 2 + 10 + "px",
                });
            });
            $(".section-5-x").each(function () {
                var leftSide = $(this).find(".right-side");
                leftSide.css({
                    "padding-right": (headerWidth - headerContainerWidth) / 2 + 10 + "px",
                });
            });
        } else {
            $(".section-8").each(function () {
    ...
    $document.ready(function () {
        if ($("#map").length > 0) {
            ...
            var locations = [["", latitude, longtitude, 2]];
            var styles = [
                {
                    featureType: "all",
    ...
    $document.ready(function () {
        ...
        $(".masonry-gallery .js-masonry-grid-works-filter").on("click", "a", function (e) {
            ...
            $(
                ".masonry-gallery .js-masonry-grid-works-filter .list-masonry-grid-works-filter__item a"
            ).each(function (index) {
    ...
    function loadPortfolioGallerySettings() {
        ...
        if ($window.width() > 991) {
            ...
            $(".portfolio-inner-page .project-info").css({
                "max-width": projectGalleryWidth + "px",
            });
            $(".portfolio-inner-page .js-in-viewport").css({
                "margin-top": projectInfoHeight + "px",
            });
        } else {
    ...
    $document.ready(function () {
        $(".arrow.minus").on("click", function (m) {
            var i = $(this)
                .parent()
                .parent()
                .find('input[name="quantity"], input[name="qty"], .js-qty');
            if (i.val() <= 1) {
                i.val("1").change();
            } else {
                var l = i.val() - 1;
