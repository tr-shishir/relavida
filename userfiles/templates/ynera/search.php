            ...
            <div class="col-12 text-center">
                <div class="m-auto allow-drop" style="max-width: 800px;">
                    <?php if($posts == 0 && $products == 0){
                            ?>
                    <h1 class="hr edit" field="search_header_empty" rel="content">No Results found<span
                            class="text-primary">.</span></h1>
                    <?php
                        }else{ ?>
                    <h1 class="hr edit" field="search_header" rel="content">Results found<span
                            class="text-primary">.</span></h1>
                    <?php
                        } ?>
                    <p class="lead mb-5"><em>Erwähnung</em> &ldquo;<?php print $keywords; ?>&rdquo;</p>
                </div>
            </div>
        </div>
    </div>
...
<section>
    <div class="container">
        ...
        <div class="shop-search-wrapper">
            ...
            <module type="shop/products" limit="18" <?php if($_REQUEST['category_list']=='ean'){ ?>
                ean="<?php print $keywords; ?>" <?php }elseif($_REQUEST['category_list']=='sku'){ ?>
                sku="<?php print $keywords; ?>" <?php }else{ ?> keyword="<?php print $keywords; ?>" <?php } ?>
