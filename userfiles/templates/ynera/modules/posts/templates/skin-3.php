...
?>
<style>
    .blog-sample.footer-single-blog {
        background-color: transparent;
        box-shadow: none;
    }

    .blog-sample.footer-single-blog .blog-sample-image-wrapper {
        width: 100px !important;
    }

    .blog-sample.footer-single-blog .blog-sample-image-wrapper .blog-sample-image {
        min-width: 100px;
        min-height: 77px !important;
    }
    .blog-sample-content h4 {
    ...
    .blog-sample.footer-single-blog .blog-sample-content {
        text-align: left;
    }

    .blog-sample.footer-single-blog h4 {
    ...
    .blog-sample.footer-single-blog h4::after {
        display: none;
    }

    .blog-sample.footer-single-blog:not(:last-child) {
        margin-bottom: 10px !important;
    }

    .footer-blog .header-blog-toggle {
    ...
    @media (max-width: 767px) {
        .footer-blog  .blog-sample.footer-single-blog {
        ...
        .blog-sample.footer-single-blog .blog-sample-title{
            padding: 0;
        }
    }
</style>
<div class="row blog-posts ">
    ...
    <?php if (!empty($data)) : ?>
    <?php foreach ($data as $count => $item) : if($count == 2)break;?> 
    ...
    <?php
        ...
        ?>
    <div class="col-md-12">
        <div class="blog-sample footer-single-blog">
