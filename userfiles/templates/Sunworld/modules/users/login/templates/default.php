    ...
    <p class="edit" field="login_massage" rel="module">Wenn Sie bereits ein Kundenkonto bei uns haben,<br/>
        ...
        <form method="post" id="user_login_<?php print $params['id'] ?>" action="#" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <p><a href="<?php print site_url()."forgot-password" ?>">Passwort vergessen ?</a></p>
                </div>
            </div>
        ...
        <div class="act create">
            <a href="#" class="js-show-register-window"><span>Einen neuen Account erstellen<i class="fa fa-forward" style="margin-left: 10px;" aria-hidden="true"></i></span></a>
        </div>
    </div>
<?php endif; ?>
