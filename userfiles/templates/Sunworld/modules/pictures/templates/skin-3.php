...
<?php if (is_array($data)): ?>
    ...
    <?php foreach ($data as $count => $item): ?>
        <?php if ($count == 0): ?>
            <div class="heading-image" onclick="mw.gallery(gallery<?php print $rand; ?>, <?php print $count; ?>);return false;"><img src="<?php print thumbnail($item['filename'], 1920, 800, true); ?>" /></div>
        <?php endif; ?>
    <?php endforeach; ?>
    <script>
