    ...
    <div class="col-xl-12 mx-auto">
        <div class="row active-new-blog">
            <?php if (!empty($data)) : ?>
                ...
                ?>
                    <div class="active-new-blog-sample col-md-6 col-lg-4 <?php if ($key == 2 and is_array($data) and count($data) == 3) : ?>d-block d-md-none d-lg-block<?php endif; ?>" <?php if (is_live_edit()) : ?>no-<?php endif; ?> itemscope itemtype="<?php print $schema_org_item_type_tag ?>">
                            ...
                            <a href="<?php ($item['is_rss'] == 1) ? print $item['rss_link'] : print $item['link'] ?>" itemprop="url">
                                <div class="thumbnail-holder">
                                    ...
                                    <?php if (!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)) : ?>
                                        <div class="image" style="background-image: url('<?php ($item['is_rss'] == 1) ? print $item['rss_image'] : print thumbnail($item['image'], 535, 285, true); ?>');">
