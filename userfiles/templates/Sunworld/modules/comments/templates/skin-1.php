                ...
                <div class="reviews">
                    ...
                    <?php if ($are_disabled == false) : ?>
                        <?php if (!$login_required or $cur_user != false): ?>
                            <a href="javascript:;" class="js-show-review-form btn btn-primary btn-lg btn-block">Hinterlasse einen Kommentar</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="row leave-review js-review-form m-t-20" style="display: none;">
                    <div class="col-12">
                        ...
                        <div class="right-side">
                            ...
                            <p>Wir werden uns freuen zu hören, was Sie über diesen Beitrag denken</p>
