...
<head>
    ...
    <style>
        ...
        .member-nav .search .product-search-box button {
            background-color: #000;
            color: #fff;
...
<body class="<?php print helper_body_classes(); ?> <?php print 'member-nav-inverse ' . $header_style . ' ' . $sticky_navigation; ?> ">
    ...
    <module type="template_settings" id="mw-template-theplace" />
                        ...
                        <div class="header-menu-wrapper">
                                        ...
                                        <li class="mobile-profile">
                                            <!-- <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                                    aria-haspopup="true" aria-expanded="true"><i
                                                        class="fa fa-user-circle-o"></i> <span>Hi
                                                        <?php print user_name(); ?> <span
                            ...
                            <ul class="member-nav">
                                ...
                                <li class="dropdown btn-cart">
                                    <a href="#" class="cart-dropdown-btn preloader-cart-icon" onclick="carttoggolee('cart')"><span class="material-icons cart-icon">
                                            shopping_cart
                                ...
                                <li class="dropdown btn-member">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span><?php if (user_id()) : ?><?php print user_name(); ?><?php else : ?><?php echo _e('Einloggen'); ?><?php endif; ?>
                                            <span class="caret"></span></span></a>
                                    <ul class="dropdown-menu">
                                        <?php if (user_id()) : ?>
                                            <li><a href="#" data-toggle="modal" data-target="#loginModal">Profil</a>
                                            </li>

                                            <li><a href="#" data-toggle="modal" data-target="#ordersModal">Meine Bestellungen</a>
                                            </li>
                                        <?php else : ?>
                                            <li><a href="#" data-toggle="modal" data-target="#loginModal" class="login_register">Anmeldung</a>
                                            </li>
                                        <?php endif; ?>

                                        <?php if (is_admin()) : ?>
                                            <li><a href="<?php print admin_url() ?>">Adminbereich</a>
                                            </li>
                                        <?php endif; ?>

                                        <?php if (user_id()) : ?>
                                            <li><a href="<?php print api_link('logout') ?>">Ausloggen</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
