...
<script>
    $(document).ready(function () {
        ...
        $("#header-menu>.navbar_new>ul").attr('id','custom_nav');
...
@media screen and (min-width: 991px){
    ...
    .header-menu-wrapper ul.list>li li.expandTrue {
        background: #fff;
    }

    .header-menu-wrapper ul.list>li li.expandTrue>a {
        color: #202020 !important;
    }

    .header-menu-wrapper ul.list>li li.expandTrue>.expandCat>i {
        color: #202020 !important;
    }
    .header-menu-wrapper ul.list>li>a {
