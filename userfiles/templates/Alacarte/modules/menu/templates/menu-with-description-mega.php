...
<style>
    ...
    #header-menu .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li ul.dropdown-menu {
    ...
    #header-menu .menu-with-description li.dropdown.has-sub-menu ul.dropdown-menu li ul.dropdown-menu li {
        width: 100% !important;
    }
    #header-menu .menu-with-description ul li ul li>a {
