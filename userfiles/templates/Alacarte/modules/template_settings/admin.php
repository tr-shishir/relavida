...
$theme_color_1 = get_option('theme-color-1', 'mw-template-theplace');
if ($theme_color_1 == '') {
    $theme_color_1 = '';
}

$theme_color_2 = get_option('theme-color-2', 'mw-template-theplace');
if ($theme_color_2 == '') {
    $theme_color_2 = '';
}

$theme_color_3 = get_option('theme-color-3', 'mw-template-theplace');
if ($theme_color_3 == '') {
    $theme_color_3 = '';
}

$theme_color_4 = get_option('theme-color-4', 'mw-template-theplace');
if ($theme_color_4 == '') {
    $theme_color_4 = '';
}

$theme_color_5 = get_option('theme-color-5', 'mw-template-theplace');
if ($theme_color_5 == '') {
    $theme_color_5 = '';
}
?>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-1" class="form-control mw_option_field" data-refresh="template_settings"
               data-also-reload="template_settings" name="theme-color-1" data-option-group="mw-template-theplace"
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-2" class="form-control mw_option_field" data-refresh="template_settings"
               data-also-reload="template_settings" name="theme-color-2" data-option-group="mw-template-theplace"
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-3" class="form-control mw_option_field" data-refresh="template_settings"
               data-also-reload="template_settings" name="theme-color-3" data-option-group="mw-template-theplace"
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-4" class="form-control mw_option_field" data-refresh="template_settings"
               data-also-reload="template_settings" name="theme-color-4" data-option-group="mw-template-theplace"
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input id="theme-color-5" class="form-control mw_option_field" data-refresh="template_settings"
               data-also-reload="template_settings" name="theme-color-5" data-option-group="mw-template-theplace"
