...
?>
    <div class="row shop-products">
        ...
        ?>
            ...
            <div class="col-12 col-md-6 col-lg-3 col-xl-3 item-<?php print $item['content_id'] ?>" data-masonry-filter="<?php //print $itemCats; ?>" itemscope itemtype="<?php //print $schema_org_item_type_tag ?>">
                <div class="product">
