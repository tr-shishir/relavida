...
*/
?>
<link rel="stylesheet" href="<?php print template_url(); ?>modules/shop/products/product_style.css" type="text/css"/>
<?php
...
?>
    <div class="row shop-products">
        ...
        ?>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 item-<?php print $item['content_id'] ?>" data-masonry-filter="<?php //print $itemCats; ?>" itemscope itemtype="<?php //print $schema_org_item_type_tag ?>">
                <div class="product">
                    ...
                    <?php if ($show_fields == false or in_array('thumbnail', $show_fields)) : ?>
                        <div class="image" style="background-image: url('<?php print  $image_link; ?>');">
                            <a href="<?php print url($item['url']); ?>" class="d-flex h-100 w-100"></a>
                        </div>
                    <?php endif; ?>
                    <div class="m-t-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 product-checkout-button">
                                ...
                                <div style="margin-bottom:8px">
                                    <?php if ($show_fields == false or in_array('add_to_cart', $show_fields)):?>
                                        <?php if (!isset($in_stock) or $in_stock == false) : ?>
                                            <a href="javascript:;" disabled="disabled" class="btn btn-primary cart-disable"><i class="material-icons">remove_shopping_cart</i> <?php _e('Out Of Stock'); ?></a>
                                        <?php elseif(isset($item['price']) && !(floatval($item['price']) > 0)): ?>
                                            <a href="javascript:;" title="<?php _e('Price On Request'); ?>" onclick="priceModal(); price_on_request_product_id_get(<?php print $item['content_id']; ?>,'<?php print $item['title']; ?>');"   class="btn btn-primary" ><?php _e('Price On Request'); ?></span></a>
                                        <?php else : ?>
                                ...
                                <div>
                                    <?php if (is_admin() == 1) : ?>
                                        <button class="btn btn-primary copy-url" type="button" data-id="<?php echo $item['content_id']; ?>" data-lang="<?= url_segment(0); ?>"><i class="fa fa-files-o" style="margin-right:5px;" aria-hidden="true"></i>Schnelle Kaufabwicklung</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
