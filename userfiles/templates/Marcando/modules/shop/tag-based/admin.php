...
<div class="post-settings-holder">
    ...
    <?php
        if(strpos($params['id'], 'shop-tag-based') !== false){
?>
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                ...
                                <input type="hidden" class="form-control mw-full-width mw_option_field_dt"  name="data-tags"  value="<?php print $tags_val; ?>"  id="tags"/>
                            </div>
                        </div>
