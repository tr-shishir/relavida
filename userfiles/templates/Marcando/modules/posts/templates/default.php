            ...
            <div class="col-md-4">
                <div class="blog-sample">
                    <?php if (!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)) : ?>
                        <div class="blog-sample-image" style="background-image: url('<?php ($item['is_rss'] == 1) ? print $item['rss_image'] : print thumbnail($item['image'], $thumb_quality, $thumb_quality, true); ?>');">
