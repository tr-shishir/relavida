...
<?php
    $data = DB::table('product')
            ...
            ->where('is_active', 1)
            ->select('id', 'url', 'title', 'quantity', 'sku', 'position')
            ->first();
    $data = (array)$data;
...
<div class="shop-inner-page inner-page" id="shop-content-<?php print $data['id']; ?>">
                            ...
                            <div class="product-info-content">
                                <div class="box">
                                    <div class="heading mobile-view-hide">
                                        <h1 class=""><?php print $data['title']; ?></h1>
                                    </div>
                                    <div class="">
                                        <?php
                                    ...
                                    <div class="ph-info-stock">
                                            ...
                                            <?php if (isset($data['sku'])) : ?>
                                                <p class="labels"><?php _lang("SKU Number") ?>: <span>#<?php print $data['sku']; ?></span></p>
                                            <?php endif; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="description <?php  if($check_readmore_value == "1") { echo "readmore-btn-enabled"; } ?>">
                                                <div class="typography-area" rel="content">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="owl-featured m-b-80"><strong>Dies könnte Sie auch interessieren</strong></h2>
                         <module type="shop/productsv2/templates/default" related="true" limit="6" hide_paging="true" />
                    </div>
                </div>
            </div>
        </div>
