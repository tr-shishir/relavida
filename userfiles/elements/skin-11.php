<div class="container mw-static-element mw-vertical-centered-text-and-image" id="text-image-left-<?php print CONTENT_ID; ?>">
    <div class="image">
...
<div class="container mw-static-element mw-vertical-centered-text-and-image" id="text-image-right-<?php print CONTENT_ID; ?>">
    <div class="info">
        <h4>Our Experience</h4>
        <p>
            It is a long est`ablished fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a
