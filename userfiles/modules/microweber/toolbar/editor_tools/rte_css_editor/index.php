...
<div data-mwcomponent="accordion" class="mw-ui-box mw-accordion">
    ...
    <div class="mw-accordion-content mw-ui-box-content">
        ...
        <!-- <div class="mw-field unit" data-prop="opacity" data-size="medium"></div>  -->
        <div class="s-field">
            <label><?php _e("Opacity"); ?></label>
            <div class="s-field-content">
                <div class="mw-multiple-fields">
                    <input type="range" min="0" step=".01" max="1" data-prop="opacity" value="1" class="opacity">
                </div>
            </div>
        </div>
