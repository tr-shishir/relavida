...
mw.propEditor = {
    ...
    interfaces:{
        ...
        shadow: function(proto, config){
            ...
            var labelX = mw.propEditor.helpers.label('X Versatz');
            var labelY = mw.propEditor.helpers.label('Y Versatz');
            var labelBlur = mw.propEditor.helpers.label('Verschwommen');
            var labelSpread = mw.propEditor.helpers.label('Größe');
            var labelColor = mw.propEditor.helpers.label('Farbe');
