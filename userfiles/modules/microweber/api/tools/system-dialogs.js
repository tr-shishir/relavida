...
mw.tools.confirm = function (question, callback, onCancel) {
    ...
    question = question || 'Are you sure?';
        ...
        var ok = mw.top().$('<span tabindex="99999" class="mw-ui-btn mw-ui-btn-medium mw-ui-btn-info">' + mw.lang('Ok') + '</span>');
        var cancel = mw.top().$('<span class="mw-ui-btn mw-ui-btn-medium ">' + mw.lang('Cancel') + '</span>');
        var modal;
