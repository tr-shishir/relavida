(function () {
    ...
    mw.msg = mw._lang = {
        ...
        exportAllOrders: '<?php _e("Export all orders"); ?>',
        ifYouCheckThisCheckboxThenAllOfYourOrdersWillBeAddedIntoTheBackupExport: '<?php _e("If you check this checkbox then all of your orders will be added into the backup export"); ?>',
        exportUsers: '<?php _e("Export users"); ?>',
        thisCheckBoxWillIncludeAllYourUserDatabaseInTheBackup: '<?php _e("This check box will include all your user database in the backup"); ?>',
        exportMenus: '<?php _e("Export menus"); ?>',
        ifYouWantToIncludeTheExistingMenusInTheBachupUseThisCheck: '<?php _e("If you want to include the existing menus in the bachup use this check"); ?>',
        exportComments: '<?php _e("Export comments"); ?>',
        exportAllCommentsOfYourWebsite: '<?php _e("Export all comments of your website"); ?>',
        exportContacts: '<?php _e("Export contacts"); ?>',
        exportAllContactListsOfYourWebsite: '<?php _e("Export all contact lists of your website"); ?>',
        exportPostsContents: '<?php _e("Export Posts & Contents"); ?>',
        exportAllPostsContentsOfYourWebsite: '<?php _e("Export all posts & contents of your website"); ?>',
        exportWebsiteSettings: '<?php _e("Export  website settings"); ?>',
        allSettingsLinkWebsiteNameCompanyDetailsEtc: '<?php _e("All settings link, website name, company details etc"); ?>',
        includeMediaFiles: '<?php _e("Include media files"); ?>',
        imagesVideosEtc: '<?php _e("images, videos, etc"); ?>',
        nothingSelected: '<?php _e("Nothing selected"); ?>',
        internalSettings: '<?php _e("Internal settings"); ?>',
        liveEditSettings: '<?php _e("Live Edit settings"); ?>',
        statisticsSettings: '<?php _e("Statistics settings"); ?>',
        folderName: '<?php _e("Folder name"); ?>',
        confirm: '<?php _e("Confirm"); ?>',
        editHTML: '<?php _e("Edit HTML"); ?>',
        editStyle: '<?php _e("Edit Style"); ?>',
        remove: '<?php _e("Remove"); ?>',
        insert: '<?php _e("Insert"); ?>',
        moveUp: '<?php _e("Move Up"); ?>',
        moveDown: '<?php _e("Move Down"); ?>',
        copy: '<?php _e("Copy"); ?>',
        pasteUp: '<?php _e("Paste Up"); ?>',
        pasteDown: '<?php _e("Paste Down"); ?>',
        resetModule: '<?php _e("Reset module"); ?>',
        presets: '<?php _e("Presets"); ?>',
        button: '<?php _e("Button"); ?>',
        products: '<?php _e("Products"); ?>',
        layouts: '<?php _e("Layouts"); ?>',
        continueWithoutSaving: '<?php _e("Continue without saving"); ?>',
        reset: '<?php _e("Reset"); ?>',
