        ...
        _setdesktopType: function () {
            ...
            if(scope.settings.uploaderType === 'big') {
                $zone = $('<div class="mw-file-drop-zone">' +
                    ...
                    '<span class="mw-ui-btn mw-ui-btn-rounded mw-ui-btn-info">Bild hinzufügen oder per Drang and Drop reinziehen</span> ' +
                    '</div>' +
                    '</div>');
            } else if(scope.settings.uploaderType === 'small') {
                $zone = $('<div class="mw-file-drop-zone mw-file-drop-zone-small mw-file-drop-square-zone"> <div class="mw-file-drop-zone-holder"> <span class="mw-ui-link">Bild hinzufügen oder per Drang and Drop reinziehen</span></div> </div>')
            }
