...
//        $('body > .main').addClass('show-sidebar-tree');
    ...
    <main>
                                         ...
                                         <div class="collapse-x" id="allow-users-social-newtworks-login">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox d-flex align-items-center">
                                                    ...
                                                    <label class="custom-control-label mr-2 d-flex" for="customCheck1"><i class="mdi mdi-microweber mdi-30px lh-1_0 mr-2"></i> Droptienda login enabled?</label>
                                                </div>
                                            </div>

                                            <div class="collapse" id="mw-login-settings">
                                                <small class="d-block mb-1">Please enter your credentials for Droptienda Login Server</small>
        ...
        <div class="row copyright mt-3">
            <div class="col-12">
                <p class="text-muted text-center small">Open-source website builder and CMS Droptienda 2020. Version: 1.18</p>
            </div>
        </div>
    </main>
