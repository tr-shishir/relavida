...
function collapseNav(selector, config) {
    ...
    function init(selector, config) {
        ...
        /*----------------------------------------
         ...
         ----------------------------------------*/
        if($("#header-menu").find(".add_more_nav").length !== 0){
            var btn_n = 0;
            ...
            $(navigation).append('<li class="' + li_class + ' hasSubMenu leftSubmenu"><a href="javascript:;" class="' + li_a_class + '" role="button" aria-haspopup="true" aria-expanded="false">' + more_text + caret + '</a><span class="expandCat"><i class="fa fa-caret-down"></i></span>' + ul + '</li>')
        }
