    ...
    mw.Dialog = function (options, cres) {
        ...
        this.title = function (title) {
            ...
            if (typeof title === 'undefined') {
                ...
                if (root[0]) {
                    ...
                    mw.$(this.dialogHeader).prepend('<div class="mw-dialog-title">' + mw.lang(title) + '</div>');
                }
                page_reload_status = title.includes("Pricing Card");
            }
        };
        ...
        this.build = function () {
            ...
            this.closeButton.onclick = function () {
                ...
                if(page_reload_status){
                    // mw.reload_module('pricing_card');
                    location.reload();
                }
            };
