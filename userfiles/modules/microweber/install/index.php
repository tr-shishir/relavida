...
<html>
<head>
    <title><?php _e("Droptienda installation"); ?></title>
    <meta charset="utf-8">
...
<div class="installholder">
 ...
 <small class="version">v. <?php print Config::get('app.adminTemplateVersion'); ?></small>
<div class="mw-ui-box">
<div class="mw-ui-box-header">
<a href="http://droptienda.com" target="_blank" id="logo">
  ...
  if ($is_pdo_loaded == false) {
    ...
    <?php if ($check_pass == false): ?>
        <?php if (!empty($server_check_errors)): ?>
            ...
            <h4>
                <?php _e("There are some errors on your server that will prevent Droptienda from working properly"); ?>
            </h4>
            <ol class="error">
        ...
        <form method="post" id="form_<?php print $rand; ?>" autocomplete="true">
            ...
            <div class="hr"></div>
                ...
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        <?php _e("Table prefix"); ?>
                        <span data-help="<?php _e("Change this If you want to install multiple instances of Droptienda to this database. Only latin letters and numbers are allowed."); ?>"><span class="mw-icon-help-outline mwahi tip"></span></span></label>
