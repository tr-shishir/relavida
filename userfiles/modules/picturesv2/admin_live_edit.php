...
<div class="pictures-admin-container">
    ...
    <div class="tab-content py-3">
        <div class="tab-pane fade show active" id="list">
                        ...
                        <tr>
                            ...
                            <td width="50%" align="right">
                                <div class="pull-right">
                                    <module id="edit-post-gallery-main-source-selector-holder" type="picturesv2/admin_upload_pic_source_selector" />
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <module type="picturesv2/admin_backend" for="<?php print $for ?>" for-id="<?php print $for_id ?>" id="mw-pics-list-live-ed" />
        </div>
