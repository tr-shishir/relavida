...
<form id="edit-mail-template-form">
    <div class="card bg-light style-1 mb-3">
        ...
        <div class="card-body pt-3">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <small class="text-muted d-block mb-2"><?php _e("What kind of email template is this about?"); ?></small>
                        <div>
            ...
            <h5 class="mb-3"><?php _e("Sending the email"); ?></h5>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-4">
                        <label class="control-label"><?php _e("Name of the shipper"); ?></label>
            ...
            <h5 class="mb-3"><?php _e("Email message"); ?></h5>
            <div class="row">
                <div class="col-12">
                    <div class="form-group mb-4">
                        <label class="control-label"><?php _e("E-mail subject"); ?></label>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <button type="submit" name="submit" class="btn btn-success btn-sm"><?php _e("Save"); ?></button>
                </div>
            </div>
