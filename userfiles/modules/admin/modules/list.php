            ...
            <?php if (isset($dynamic_layout['template_dir']) and isset($dynamic_layout['layout_file'])) : ?>
                <li data-module-name="layout" template="<?php print $dynamic_layout['template_dir'] ?>/<?php print $dynamic_layout['layout_file'] ?>" data-filter="<?php print $dynamic_layout['name'] ?>" class="module-item" unselectable="on"> <span class="mw_module_hold">
                        ...
                        <span class="mw_module_image"> <span class="mw_module_image_holder">
                                <img alt="<?php print $dynamic_layout['name'] ?>" title="<?php isset($dynamic_layout['description']) ? print addslashes($dynamic_layout['description']) : print addslashes($dynamic_layout['name']); ?>" class="module_draggable" data-module-name-enc="static_layout_<?php print date("YmdHis") . $i++ ?>" data-module-name="<?php print $dynamic_layout['layout_file'] ?>" src="<?php print $dynamic_layout['icon'] ?>" /> </span></span> <span class="module_name" alt="<?php isset($dynamic_layout['description']) ? print addslashes($dynamic_layout['description']) : ''; ?>">
            ...
            if (isset($dynamic_layout['layout_file']) && $des != 'optinform') : ?>
                <li data-module-name="layouts" ondrop="true" template="<?php print $dynamic_layout['layout_file'] ?>" data-filter="<?php print $dynamic_layout['name'] ?>" class="<?php if ($dynamic_layout['name'] == "Contact Form") { ?> hide-li <?php } ?> module-item module-item-layout" unselectable="on">
                    <span class="mw_module_hold">
                        ...
                        <span class="module_name" alt="<?php isset($dynamic_layout['description']) ? print addslashes($dynamic_layout['description']) : ''; ?>">
                            <?php 
                                if(isset($dynamic_layout['name'])){
                                    $slug = preg_replace('/_/', ' ', $dynamic_layout['name']);
                                    $slug = ucwords($slug);
                                    _e($slug);
                                } 
                            ?>
        ...
        <?php foreach ($modules_by_categories as $mod_cat => $modules) : ?>
            ...
            <?php foreach ($modules as $module_item) : ?>
                ...
                <?php if (isset($module_item['module'])) : ?>
                    ...
                    <li <?php if (isset($hide_from_display_list) and in_array($module_item['module'], $hide_from_display_list)) { ?> style="display: none" <?php } ?> <?php if (!isset($params['clean'])) { ?> id="<?php print $module_id; ?>" <?php } ?> data-module-name="<?php print $module_item['module'] ?>" <?php if ($mod_obj_str == 'elements') : ?> style="" <?php endif; ?> data-filter="<?php print $module_item['name'] ?>" ondrop="true" data-category="<?php isset($module_item['categories']) ? print addslashes($module_item['categories']) : ''; ?>" <?php if (isset($module_item['template'])) { ?> template="<?php print $module_item['template'] ?>" <?php } ?> class="<?php if ($module_item['name'] == "Dropfunnels" || $module_item['name'] == "Preisvergleich-Export" || $module_item['name'] == "Contact-form") { ?> hide-li <?php } ?> module-item module-item-module module-cat-toggle-<?php print $mod_cat ?> <?php if ($mod_obj_str == 'elements') : ?>default-layouts<?php endif; ?><?php if (isset($module_item['as_element']) and intval($module_item['as_element'] == 1) or (isset($is_elements) and $is_elements == true)) : ?> module-as-element<?php endif; ?>">
                        <span unselectable="on" class="mw_module_hold" title="<?php _e(addslashes($module_item["name"]) . ' ' . addslashes($module_item["description"])); ?>">
                            ...
                            <?php if (isset($module_item['icon']) and $module_item['icon']) : ?>
                                <span class="mw_module_image">
                                    <span class="mw_module_image_holder">
                                        <img alt="<?php print $module_item['name'] ?>" title="<?php isset($module_item['description']) ? print addslashes($module_item['description']) : ''; ?>" class="module_draggable" data-module-name-enc="<?php print $module_item['module_clean'] ?>|<?php print $module_item['name_clean'] ?>_<?php print date("YmdHis") ?>" data-src="<?php print $module_item['icon']; ?>" />
                                    </span>
                                </span>
                            <?php endif; ?>
