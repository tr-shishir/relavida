...
<?php endif; ?>
<style>
    select#card-module-shadow-option {
    width: 100%;
    height: 36px;
    border-radius: 5px;
}
                        ...
                        <div class="mw-mod-template-settings-holder">
                            ...
                            <?php if (isset($current_template)): ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php if(isset($current_template['name']) && $current_template['name'] == 'Cards'): ?>
                                        <div class="col-12 current-template-modules">
                                            <div class="cards-shadow">
                                                <p>Please select card shadow option from here.</p>
                                                <div class="shadow-select" >
                                                    <?php $cards_shadow_option = get_option('Cards','cards_module_shadow'); ?>
                                                    <select name="card-module-shadow-option" id="card-module-shadow-option">
                                                        <option value="false">No-Shadow</option>
                                                        <option value="cards-module-small-shadow" <?php if($cards_shadow_option == "cards-module-small-shadow"): ?> selected <?php endif; ?>>Small-Shadow</option>
                                                        <option value="cards-module-medium-shadow" <?php if($cards_shadow_option == "cards-module-medium-shadow"): ?> selected <?php endif; ?>>Medium-Shadow</option>
                                                        <option value="cards-module-large-shadow" <?php if($cards_shadow_option == "cards-module-large-shadow"): ?> selected <?php endif; ?>>Large-Shadow</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <script>
                                            $('#card-module-shadow-option').on('change',function(){
                                                $.ajax({
                                                    type: "POST",
                                                    url:"<?=api_url("cards_module_shadow_set")?>",
                                                    data:{module_name : '<?php print $current_template['name']; ?>',shadow_type:this.value},
                                    ...
                                    <div class="col-12 current-template-modules">
                                        <div class="current-template-modules-list-wrap">
                                            <label class="control-label"><?php  _e('This layout contains those modules');  ?></label>
                        ...
                        <?php if ($search_bar): ?>
                            ...
                            <div class="form-group">
                                <div class="input-group prepend-transparent mb-0">
                                    ...
                                    <input type="text" class="form-control" id="module-skins-search" autocomplete="off" aria-label="Search" placeholder="<?php _e('Search'); ?>">
                                </div>
                            </div>
                        <?php endif; ?>
                                        ...
                                        <?php if ((strtolower($item['name']) != 'default')): ?>
                                            <a href="javascript:;" class="js-apply-template"
                                               data-file="<?php print $item['layout_file'] ?>">
                                                <?php if ($item['layout_file'] == $cur_template): ?>
                                                    <div class="default-layout"><?php _e('DEFAULT'); ?></div>
                                                <?php endif; ?>
