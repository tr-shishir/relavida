            ...
            <div class="export-stepper-3">
                ...
                <div class="export-stepper-content">
                    ...
                    <div class="step-actions step-actions-3">
                        <a class="mw-ui-btn mw-ui-btn-info" onclick="mw.backup_export.export_start()"><?php _e('Export selected data'); ?></a>
                    </div>

                </div>
            </div>
            <div class="export-stepper-4">
                <h3 class="export-step-4-action"><?php _e('Exporting your content'); ?></h3>
                <div class="export-stepper-content">
        ...
        <?php if (user_can_access('module.admin.backup_v2.create') || user_can_access('module.admin.backup_v2.edit')): ?>
            <div class="col-6 mb-4">
                ...
                <small class="text-muted d-block mb-3"><?php _e("Supported files formats"); ?>
                    ...
                    <a href="<?php print $here; ?>samples/sample.xlsx" class="mw-ui-link">xls</a><?php _e('and'); ?>
                    <a href="<?php print $here; ?>samples/other_cms.zip" class="mw-ui-link"><?php _e('other files'); ?></a>.
                </small>
                <span id="mw_uploader" class="btn btn-primary btn-rounded"><i class="mdi mdi-cloud-upload-outline"></i>&nbsp; <?php _e("Upload backup"); ?></span>
