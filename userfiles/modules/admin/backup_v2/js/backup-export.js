            ...
            data: [
                {
                    ...
                    title: mw.lang('Export all orders'),
                    description: mw.lang('If you check this checkbox then all of your orders will be added into the backup export')
                },
                {
                    input: {name: 'export_items', value: 'users'},
                    icon: { className: 'mdi mdi-account-multiple-outline'  },
                    title: mw.lang('Export users'),
                    description: mw.lang('This check box will include all your user database in the backup')
                },
                {
                    input: {name: 'export_items', value: 'menus'},
                    icon: { className: 'mdi mdi-menu'  },
                    title: mw.lang('Export menus'),
                    description: mw.lang('If you want to include the existing menus in the bachup use this check')
                },
                {
                    input: {name: 'export_items', value: 'comments'},
                    icon: { className: 'mdi mdi-comment-account-outline'  },
                    title: mw.lang('Export comments'),
                    description: mw.lang('Export all comments of your website')
                },
                {
                    input: {name: 'export_items', value: 'forms_data,forms_lists,notifications'},
                    icon: { className: 'mdi mdi-email-outline'  },
                    title: mw.lang('Export contacts'),
                    description: mw.lang('Export all contact lists of your website')
                },
                {
                    input: {name: 'export_items', value: 'forms_data,forms_lists'},
                    icon: { className: 'mdi mdi-format-list-text'  },
                    title: mw.lang('Export Posts & Contents'),
                    description: mw.lang('Export all posts & contents of your website')
                },
                {
                    input: {name: 'export_items', value: ''},
                    icon: { className: 'mdi mdi-cog-outline'  },
                    title: mw.lang('Export  website settings'),
                    description: mw.lang('All settings link, website name, company details etc')
                },
                {
                    input: {name: 'export_media', value: true, checked: true},
                    icon: { className: 'mdi mdi-image-multiple-outline'  },
                    title: mw.lang('Include media files'),
                    description: mw.lang('images, videos, etc.')
                }
