...
class Backup
{
    ...
    public function exec_create_full()
    {
        ...
        $zip->setComment("Droptienda backup of the userfiles folder and db.
                \n The Droptienda version at the time of backup was {MW_VERSION}
...
//                $stmt = preg_replace('/[\x00-\x08\x0B\x0C\x0E-\x1F\x80-\x9F]/u', '', $stmt);
    ...
    public function create($filename = false)
    {
        ...
        $head = '/* Droptienda database backup exported on: ' . date('l jS \of F Y h:i:s A') . " */ \n";
