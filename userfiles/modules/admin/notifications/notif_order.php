...
?>
<?php $drm_url = env('DRM_BASE_URL', 'https://drm.software').'/admin/drm_all_orders?droptienda-item='.$item['id']; ?>
    ...
    <div class="card-body py-2">
            ...
            <div class="col-12 col-md-6">
                <div class="row align-items-center h-100">
                    <div class="col-6 col-sm-4 col-md item-amount">
                        ...
                        <?php if (isset($order['is_paid']) || $order['order_status'] == "Zahlung eingegangen"): ?>
                            <small class="text-success"><?php _e('Paid'); ?></small>
                        <?php else: ?>
                            <small class="text-muted"><?=$order['order_status']?></small>
                        <?php endif; ?>
                    </div>
        ...
        <div class="row mt-3">
            <div class="col-12 text-center text-sm-left js-change-button-styles">
                <a href="<?php print admin_url('view:shop/action:orders#vieworder=' . $item['id']); ?>" class="btn btn-outline-primary btn-sm btn-rounded" style="display:none;">View order</a>
                <a href="<?=$drm_url; ?>" target="_blank" class="btn btn-outline-secondary btn-sm btn-rounded"><?php _e("DRM order"); ?></a>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            <?php else: $pay_methode = explode("/",$order['payment_gw']);
                                $order['payment_type'] = end($pay_methode) ?? $order['payment_gw'];
                                echo str_replace("_"," ",$order['payment_type']);
                                ?>
                            <?php endif; ?>
                        </p>
                    </div>
