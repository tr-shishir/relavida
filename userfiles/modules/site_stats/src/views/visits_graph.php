...
<script>
    ...
    $(document).ready(function () {
        <?php if(get_option('language', 'website') == 'en'): ?>
            $.getScript('<?php print modules_url(); ?>microweber/api/libs/apexcharts/apexcharts.js', function () {
            var el = document.querySelector('.dashboard_stats');
            var chart = new ApexCharts(el, options);
            chart.render();
        })
        <?php elseif(get_option('language', 'website') == 'de'): ?>
            $.getScript('<?php print modules_url(); ?>microweber/api/libs/apexcharts/de_apexcharts.js', function () {
            var el = document.querySelector('.dashboard_stats');
            var chart = new ApexCharts(el, options);
            chart.render();
        })
        ...
        <div class="card-body stat-box-content">
            ...
            <div class="stats_box_footer">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-6 col-sm d-flex align-items-center justify-content-center">
                        <i class="mdi mdi-comment-account mdi-24px text-muted text-opacity-6"></i> <span class="text-primary mx-2"><?php print $comments_count; ?></span> <span><?php _e('Total Comment'); ?></span>
                    </div>
