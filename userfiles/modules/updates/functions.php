...
//    print '<div type="site_stats/admin" class="mw-lazy-load-module" id="site_stats_admin"></div>';
    ...
    if (isset($_GET['install_done']) and mw()->ui->disable_marketplace != true) {
        print '<h1 style="font-size: 24px; color: #555555;">Welcome to Droptienda ' . Config::get('app.adminTemplateVersion') . '</h1>';
        print '<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom: 5px;">Use Droptienda to build your website, online shop or blog.</p>';
        print '<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom:30px;">Create and  edit content, sell online, manage orders and clients with Open Source CMS Droptienda.</p>';
    }
});
