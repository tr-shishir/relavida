...
<div id="settings-holder">
    <div class="col-12">
        <h4 style="font-weight: bold;"><?php _e("Template Settings"); ?></h4>
    </div>
        ...
        <?php if ($template_settings): ?>
            <?php foreach ($template_settings as $key => $setting): ?>
                ...
                <?php elseif ($setting['type'] == 'sliderRange'): ?>
                    <div class="form-group">
                        <label class="control-label mw-ui-label"><?php _e($setting['label']); ?> <?php if (isset($setting['help'])): ?><span class="tip" data-tip="<?php echo $setting['help']; ?>"><span class="red">?</span></span><?php endif; ?></label>
                        <input style="padding: 0px;" type="range" min="0" step="0.01" max="1" class="form-control mw-ui-field mw_option_field" name="<?php echo $key; ?>" value="<?php echo $$key ?>" data-option-group="<?php echo $option_group; ?>" placeholder="Default: <?php echo $setting['default']; ?>">
                    </div>
