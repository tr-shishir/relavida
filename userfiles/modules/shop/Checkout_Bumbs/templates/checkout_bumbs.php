...
<div class="checkout-bumbs">
    ...
    <?php if (!empty($data)):
                ...
                $data = collect($data)->where('id',$temp->product_id);
                 ?>
        <div class="shop-products related-products">
        <div class="cart_bumbs-checkout-text edit" field="cart_bumbs_checkout_editableText" rel="content">
            <module type="text"/>
        </div>
            <?php foreach ($data as $item):  ?>
                ...
                <?php if($temp): ?>
                    ...
                    <div class="product checkout-bumbs-product item-<?php print $item['id'] ?>">
                        ...
                        ?>
                        <div class="checkout-bumbs-product-photo">
                        ...
                        <div class="checkout-bumbs-product-description">
                            <a href="<?php print $item['link'] ?>">
                                <div class="description">
                                    ...
                                    <?php endif; ?>
                                    <div class="checkout-bumbs-cartButton" >
