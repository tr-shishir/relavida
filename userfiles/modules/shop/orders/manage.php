...
<script>
    ...
    mw.on.hashParam('orderstype', function () {
        ...
        if (this == 'carts') {
            ...
            mw.$("#abn_cart").addClass('active');
            mw.$("#cmplt_cart").removeClass('active');

        } else {
            mw.$('.mw-admin-order-sort-completed').show();
            mw.$("#abn_cart").removeClass('active');
            mw.$("#cmplt_cart").addClass('active');
    ...
    <div class="card style-1">
        <div class="card-header">
            <h5><i class="mdi mdi-shopping text-primary mr-3"></i> <strong><?php _e('List of orders'); ?></strong>
                ...
                <a href="javascript:window.open('https://drm.software/admin/drm_all_orders/add', '_blank').focus();" class="btn btn-sm btn-outline-success ml-2"><?php print _e('Add new order'); ?></a>
            </h5>
        ...
        <div class="card-body  pt-3 pb-0">
            <div class="manage-toobar d-flex justify-content-between align-items-center">
                <?php if ($is_orders != 0) { ?>
                    <div id="cartsnav">
                        <!-- <a href="#orderstype=completed" class="btn btn-link btn-sm px-0 text-dark">Completed orders></a>
                        <a href="#orderstype=carts" class="btn btn-link btn-sm text-muted active">Abandoned carts</a> -->
                    </div>
