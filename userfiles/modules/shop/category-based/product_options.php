...
<div class="module-product-options-settings">
  ...
  <div class="mw-ui-btn-nav">
    <span data-tip="<?php _e("Set your shipping options"); ?>" class="mw-ui-btn tip" onclick="mw.$('#mw-admin-product-shipping-options').toggle(); mw.$('#mw-admin-product-order-options').hide();"> <span><?php _e("Shipping Options"); ?></span> <span class="mw-icon-dropdown"></span> </span>
    <span data-tip="<?php _e("Set your order options"); ?>" class="mw-ui-btn tip" onclick="mw.$('#mw-admin-product-order-options').toggle(); mw.$('#mw-admin-product-shipping-options').hide();"> <span><?php _e("Order Options"); ?></span> <span class="mw-icon-dropdown"></span> </span>
          ...
          <div class="col-lg-3 col-xl">
            <div class="mw-ui-col-container">
              <div class="form-group">
                ...
                <input type="number" min="0" step=".001" name="data_shipping_weight" class="form-control" <?php if (isset($data_fields['shipping_weight'])) : ?> value="<?php print $data_fields['shipping_weight']; ?>" <?php endif; ?> />
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-xl">
