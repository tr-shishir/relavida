...
<div class="pt-4 pb-4 pl-4" style="border: 0.3px solid lightgray;">
    ...
    <div id="item" class="mt-4 mb-4">
        ...
        <label for="itemShow" style="font-size: 16px;">Zeige eine individuelle Nachricht wie zum Beispiel "jetzt Bestellen, nur noch wenige an Lager".</label>
        <div id="value" <?php if(!isset($data_show) || $data_value == "null") : ?>style="display: none;" <?php endif;?> class="mt-4">
            <div class="form-group" style="width: 50%;">
                <input type="text" class="form-control" name="itemValue" id="itemValue" onchange="save()" placeholder="<?php _e("Enter specific quantity"); ?>" <?php if(isset($data_show) && $data_value != "null") : ?>value=<?php echo $data_value;?> <?php endif;?>>
            </div>
        </div>
    </div>
</div>