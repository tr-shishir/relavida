...
<form class="js-edit-coupon-form" action="<?php print api_url('coupons_save_coupon'); ?>">
    ...
    <div class="form-group">
        ...
        <select name="discount_type" class="js-discount-type selectpicker" data-width="100%">
            <option value="percentage" <?php if($data['discount_type'] == 'percentage'): ?> selected <?php endif; ?>><?php _e('Percentage'); ?></option>
            <option value="fixed_amount" <?php if($data['discount_type'] == 'fixed_amount'): ?> selected <?php endif; ?>><?php _e('Fixed Amount'); ?></option>
        </select>
    </div>
    ...
    <div class="form-group">
        <div class="custom-control custom-switch">
            ...
            <label class="custom-control-label" for="is_active"><?php _e('Coupon Active'); ?></label>
        </div>
