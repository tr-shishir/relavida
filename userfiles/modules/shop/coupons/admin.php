...
<script>
    function editCoupon(coupon_id = false) {
        ...
        editModal = mw.tools.open_module_modal('shop/coupons/edit_coupon', data, {overlay: true, skin: 'simple', title: 'Rabattcode'})
    }
        ...
        <?php else: ?>
            ...
            <div class="module-live-edit-settings module-coupons-settings">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-group">
                        <a href="javascript:;" class="btn btn-primary btn-rounded js-add-new-coupon"><?php _e('Create discount code'); ?></a>
                    </div>
                </div>
