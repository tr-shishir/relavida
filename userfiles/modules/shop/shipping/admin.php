                        ...
                        <?php if (mw()->module_manager->is_installed($shipping_module['module'])): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch pl-0">
                                    <label class="d-inline-block mr-5" for="shipping_gw_<?php print $shipping_module['module'] ?>"><?php _e('No'); ?></label>
                                    ...
                                    <label class="custom-control-label" for="shipping_gw_<?php print $shipping_module['module'] ?>"><?php _e('Yes'); ?></label>
                                </div>
                            </div>
