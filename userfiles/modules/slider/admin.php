        ...
        <div class="tab-content py-3">
            <div class="tab-pane fade show active" id="list">
                    ...
                    $(window).on('load', function () {
                        ...
                        this.bxSettings = new mw.moduleSettings({
                            ...
                            schema: [
                                ...
                                {
                                    interface: 'text',
                                    label: '<?php _e("Slider link (URL)"); ?>',
                                    id: 'url'
                                },
                                {
                                    interface: 'text',
                                    label: '<?php _e("See more text"); ?>',
                                    id: 'seemoreText'
                                }
                            ]
                        });
                ...
                <div class="module-live-edit-settings module-bxslider-settings">
                    ...
                    <div class="mb-3">
                        <span class="btn btn-primary btn-rounded" onclick="bxSettings.addNew(0);"><?php _e('Create a new slider'); ?></span>
                    </div>
