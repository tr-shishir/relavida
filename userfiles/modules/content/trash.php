                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto item-title">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a class="btn btn-success btn-sm" href="javascript:restore_single_post_from_deletion('<?php print ($item['id']) ?>');"><?php _e("Restore"); ?></a>
                                        <?php
                                        ...
                                        if($diff <= 30 ){
                                            ...
                                            ?>
                                            <span class="text-danger ml-2 mt-2" style="font-size: 12px">
                                                <?php
                                                    echo $leftDate." days left";
                                                ?>
                                            </span>
                                        </div>
                                    </div>
                ...
                <script type="text/javascript">
                    ...
                    restore_selected_posts = function () {
                        mw.tools.confirm("<?php _ejs("Are you sure you want restore the selected content"); ?>?", function () {
                            ...
                            var arr = mw.check.collectChecked(master);
                            arr.forever = true;
							$.post("<?=api_url('remove_delete_products_info')?>", {
                                id:arr
                            }).then((res, err) => {
                            console.log(res, err);
                            });
                    ...
                    restore_single_post_from_deletion = function (id) {
                        mw.tools.confirm("<?php _ejs("Restore this content"); ?>?", function () {
                            var arr = id;
                            arr.forever = true;
							$.post("<?=api_url('remove_delete_product_info')?>", {
                                id:id
                            }).then((res, err) => {
                            console.log(res, err);
                            });
