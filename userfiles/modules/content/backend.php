...
if ($action == 'posts') {
    ...
    $tree_url_endpoint = api_url('content/get_admin_js_tree_json?is_shop=0&is_blog=1');

} elseif ($action == 'pages') {
    $pages_container_params_str = " content_type='page'  '   ";
    $tree_url_endpoint = api_url('content/get_admin_js_tree_json?is_shop=0&is_blog=0');
} elseif ($action == 'categories') {
    $pages_container_params_str = " manage_categories='yes'    ";
} elseif ($action == 'shop_categories') {
    $pages_container_params_str = " manage_categories='yes'    ";
}
...
<div id="edit-content-row">
    <?php if ($action != 'categories' and $action != 'shop_categories'): ?>
