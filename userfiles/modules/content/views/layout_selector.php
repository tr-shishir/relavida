    ...
    <div class="layouts_box_holder">
        <div class="card style-1 <?php if ($show_save_changes_buttons): ?>bg-none mb-0<?php else: ?> mb-3<?php endif; ?>">
            <div class="card-header">
                <h5><i class="mdi mdi-text-box-check-outline text-primary mr-3"></i> <strong><?php _e('Template'); ?></strong></h5>
                <div></div>
            </div>
                ...
                <div class="row">
                    <?php if ($show_save_changes_buttons): ?>
                        <div class="col-md-4 mt-3">
                            ...
                            <?php  if(isset(mw()->template->get_config()['optimized_template']) && mw()->template->get_config()['optimized_template'] =='yes'){ ?>
                                <br/>
                                <div class="performance-improved">
                                    <img src="<?php print modules_url(); ?>timeclock.png">

                                    <p>The selected template is optimized.</p>
                                </div>
                            <?php } ?>
                            <br/>
