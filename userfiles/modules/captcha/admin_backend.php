                ...
                <div class="<?php print $config['module_class'] ?>">
                    <div class="form-group">
                        ...
                        <select class="mw_option_field js-select-captcha-provider selectpicker" data-width="100%" name="provider" option-group="captcha">
                            <option value="droptienda"><?php _e("Select"); ?></option>
                            ...
                            <option value="droptienda" <?php if (get_option('provider', 'captcha') == 'droptienda'): ?>selected="selected"<?php endif; ?>>Droptienda Captcha</option>
                        </select>
                    </div>
