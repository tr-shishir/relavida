            ...
            <form class="mw-checkout-form" id="checkout_form_<?php print $params['id'] ?>" method="post" action="<?php print api_link('checkout') ?>">
                ...
                <div <?php if ($step != 2) : ?>style="display: none;" <?php endif; ?>>
                    <div class="mw-shipping-and-payment">
                        <div class="row">
                            <div class="col-xs-12">
                                <h4 class="edit nodrop" field="checkout_personal_inforomation_title" rel="global" rel_id="<?php print $params['id'] ?>"><?php _e("Personal Information"); ?></h4>
                                <hr />
                            </div>
                        </div>
                    ...
                    <button class="btn btn-default pull-right" onclick="mw.cart.checkout('#checkout_form_<?php print $params['id'] ?>');" type="button" id="complete_order_button" <?php if ($terms) : ?> disabled="disabled" <?php endif; ?>>
