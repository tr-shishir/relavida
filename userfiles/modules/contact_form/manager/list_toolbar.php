...
<div class="form-list-toolbar row d-flex align-items-center">
    <div class="col-sm-6">
        <label class="control-label d-inline-block"><?php _e("Entries for list"); ?>: <span <?php if (!$hideEditButton): ?>id="form_field_title"<?php endif; ?>><?php  _e($data['title']); ?></span></label>
