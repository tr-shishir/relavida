...
<div id="form_email_options">
    ...
    <div class="">
        <div class="form-group">
            ...
            <small class="text-muted d-block mb-2"><?php _e("Auto-responders allows you to set up automated replies to incoming email <br/>E.x. “Thank you for your request”"); ?></small>
