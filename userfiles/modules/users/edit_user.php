                        ...
                        <div class="d-block">
                            ...
                            <div class="form-group mt-4 mb-4">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <br />
                                    <a href="<?php echo admin_url();?>/view:content/action:settings?group=login#email-notifications" target="_blank"><?php _e("Edit e-mail template"); ?></a>
                                </div>
                            </div>
                            ...
                            <?php if (is_admin()) : ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label mb-1"><?php _e('Status of the user'); ?></label>
