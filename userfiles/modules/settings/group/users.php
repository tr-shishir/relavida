...
<div class="<?php print $config['module_class'] ?>">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="text-muted d-block mb-2"><?php _e('Usars can register with temporary emails like - Mailinator, MailDrop, Guerrilla...'); ?></small>
                                    </div>
        ...
        <div class="card-body pt-3 px-0">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <small class="text-muted"><?php _e("Customize your login form by selecting the fields you require and whether you want Captcha certification"); ?></small>
                </div>
                <div class="col-md-9">
                    <div class="card bg-light style-1 mb-3">
                        <div class="card-body pt-3">
                                        ...
                                        <div class="collapse <?php if ($allow_socials_login == 'y'): ?>show<?php endif; ?>" id="allow-users-social-newtworks-login">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox d-flex align-items-center">
                                                    ...
                                                    <label class="custom-control-label mr-2 d-flex" for="enable_user_microweber_registration"><i class="mdi mdi-microweber mdi-30px lh-1_0 mr-2"></i> <?php _e('Droptienda login enabled?'); ?></label>
                                                </div>
                                            </div>

                                            <div class="collapse <?php if ($enable_user_microweber_registration == 'y'): ?>show<?php endif; ?>" id="mw-login-settings">
                                                <small class="d-block mb-1"><?php _e("Please enter your credentials for Droptienda Login Server"); ?></small>
                                                <?php
                                ...
                                <div class="col-12">
                                    <div class="mb-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <small class="text-muted d-block mb-2"><?php _e("Is email verification required for a new user registration?"); ?></small>
                                        </div>
    ...
    <div class="card bg-none style-1 mb-0 card-settings">
        <div class="card-body pt-3 px-0">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h5 class="font-weight-bold"><?php _e("Customize URLs"); ?></h5>
