    ...
    <div class="mw-module-admin-wrap">
        <div class="admin-side-content" style="max-width:100%;">
            <div style="margin-bottom: 20px;">
                <a href="https://drm.software/admin/opln_mails/add" target="_blank" style="background-color:#034B76;padding:8px 15px;border-radius:15px;color:#fff;font-size:16px;font-weight:600">More design</a>
            </div>
