                            ...
                            <div class="avatars-holder <?php if (!$avatar_enabled) { ?>deactivated<?php } ?>">
                                ...
                                <div class="form-group">
                                    <label class="mw-ui-check">
                                        ...
                                        <span></span><span style="padding-left:0px"><img class="img-h-32" style="height:35px;margin-right: 10px;" src="<?php print modules_url(); ?>microweber/images/admin-logo.png" alt=""/><?php _e("Droptienda Benutzerbild"); ?></span>
                                    </label>
                                </div>
