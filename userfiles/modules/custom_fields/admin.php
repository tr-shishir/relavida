                            ...
                            <div class="card-body collapse" id="add-field-select">
                                <div class="custom-fields-add-buttons">
                                    ...
                                    <?php foreach ($fields as $field => $value): ?>
                                        <button class="btn btn-link text-dark px-1 <?php if($value == 'Price'){print 'price-hide';} ?>" onclick="javascript:addCustomFieldByVal('<?php print $field; ?>');">
                                            <div>
