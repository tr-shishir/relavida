...
class InstallController extends Controller
{
    ...
    {
        if(file_exists(base_path('config/database.php.example')) && !file_exists(base_path('config/database.php'))) {
            rename(base_path('config/database.php.example'), base_path('config/database.php'));
        }
        ...
        if ($is_installed) {
            return 'Droptienda is already installed!';
        }
        ...
        if (isset($input['make_install'])) {
            ...
            Config::set("database.connections.$dbDriver.driver", 'mysql');
            ...
            Config::set("database.connections.$dbDriver.charset", 'utf8');
            Config::set("database.connections.$dbDriver.collation", 'utf8_unicode_ci');
        ...
        $is_installed = mw_is_installed();
        if ($is_installed) {
            App::abort(403, 'Unauthorized action. Droptienda is already installed.');
        }
