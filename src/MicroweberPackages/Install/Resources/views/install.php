...
<div class="installholder">
    <small class="text-muted d-block text-right mb-2">v. <?php print Config::get('app.adminTemplateVersion'); ?></small>
    ...
    <div class="card">
        <div class="card-header d-block">
            <div class="text-center my-3">
                ...
                <?php else: ?>
                    <a href="/" target="_blank" id="logo"><img src="<?php print mw_includes_url(); ?>images/admin-logo.png" style="width: 250px" /></a>
                <?php endif; ?>
            </div>
                        ...
                        <?php if ($done == false): ?>
                            ...
                            <?php if ($check_pass == false): ?>
                                <?php if (!empty($server_check_errors)): ?>
                                    ...
                                    <h6 class="font-weight"><?php _e('There are some errors on your server that will prevent Droptienda from working properly'); ?></h6>
                                    <ol class="error">
                                            ...
                                            <div id="mw_db_setup_toggle" <?php if ($hide_db_setup == true): ?> style="display:none;" <?php endif; ?>>
                                                ...
                                                <div id="db-form-sqlite" style="display:none">
                                                    <div class="form-group">
                                                        ...
                                                        <small class="text-muted d-block mb-2"><?php _e('A writable file path that may be relative to the root of your Droptienda installation'); ?></small>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-muted d-block mb-2"><?php _e('Change this If you want to install multiple instances of Droptienda to this database. Only latin letters and numbers are allowed.'); ?></small>
                                                                ...
                                                                <select class="form-control" name="default_template" id="default_template" tabindex="6">
                                                                    <?php foreach ($templates as $template): ?>
                                                                        <?php if (isset($template['dir_name']) and isset($template['name'])): ?>
                                                                            <option  selected="selected"  value="<?php print $template['dir_name']; ?>" <?php if (isset($template['screenshot']) and ($template['screenshot']) != false): ?> data-screenshot="<?php print $template['screenshot']; ?>" <?php endif; ?>><?php print $template['name']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
