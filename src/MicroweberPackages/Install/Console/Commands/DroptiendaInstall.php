...
class DroptiendaInstall extends Command
{
    protected $name = 'dt:install';
    protected $description = 'Installs Droptienda (dt)';
    protected $installer;
    ...
    public function handle()
    {
         ...
         *
        // you can now do
        php artisan droptienda:install
        ...
        */
        ...
        $this->info('Installing Droptienda...');
