...
class FrontendController extends Controller
{
    ...
    public function frontend()
    {
        ...
        $site = site_url();
        $favicon_image = str_replace('{SITE_URL}', $site, $favicon_image);
        if ($favicon_image) {
        ...
        if ($maintenance_mode == 'y' && !is_admin()) {
            ...
            if (is_file($maintenance_template)) {
                $content_503 = new \MicroweberPackages\View\View($maintenance_template);
        ...
        if (@$content['layout_file'] == "clean.php" and @$content['simply_a_file'] == "clean.php" and @$content['subtype'] != "static") {
            $render_file = template_dir() . "404.php";
        }
...
//                $render_params['application'] = $this->app;
    ...
    private function rssContent($slug)
    {
