...
//
            ...
            $this->commands('MicroweberPackages\Install\Console\Commands\DroptiendaInstall');
       ...
       // $this->app->make('Illuminate\Contracts\Http\Kernel')->prependMiddleware(\Illuminate\Session\Middleware\StartSession::class);
        ...
        $router->aliasMiddleware('auth.ApiRequest', \MicroweberPackages\App\Http\Middleware\AuthorizeApiRequest::class);
