        ...
        if ($is_admin == true and is_array($pd)) {
            ...
            if ($template != false) {
                ...
                if ($css_cont_new != '' and $css_cont != $css_cont_new) {
                    if(file_exists($live_edit_css)){
                        $newCss = generateNewCSS(file_get_contents($live_edit_css), $css_cont_new);
                        if( $newCss == '' || $newCss==file_get_contents($live_edit_css)){
                            $css_cont_new = $css_cont_new;
                        }else{
                            $css_cont_new = $newCss;
                        }
                    }
