                                        ...
                                        if ($to_search_keyword != '') {
                                            ...
                                            if (!empty($to_search_in_fields)) {
                                                ...
                                                // mysql >= 5.6 has fulltext index support
                                                            $query->{$where_or_where}(function ($query) use ($to_search_in_fields, $to_search_keyword, $params, $table, $dbDriver, $version) {
                                                            foreach ($to_search_in_fields as $to_search_in_field) {
                                                            $to_search_keyword = str_replace('.', ' ', $to_search_keyword);
                                                            if ($dbDriver == 'pgsql') {
                                                            ...
                                                            if ($version > '5.6.10') {
                                                                $query = $query->orWhereRaw($to_search_in_field.' REGEXP "\\\b'.$to_search_keyword.'*"');
                                                            }else{
