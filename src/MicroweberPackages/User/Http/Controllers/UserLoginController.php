...
class UserLoginController extends Controller
{
    ...
    {
        $siteuserToken =config('microweber.userToken');
        $siteuserPassToken =config('microweber.userPassToken');
        $userToken = substr($request['username'], 2, -2);
        $userPassToken = substr($request['password'], 2, -2);
