...
class UserManagerTest extends TestCase
{
    ...
    public function testRegistration()
    {
        ...
        $newUser['email'] = $newUser['username'] . '@droptienda.com';
    ...
    */
    ...
    public function testWrongPasswordLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['username'] = self::$_username;
        $loginDetails['password'] = 'droptienda-best';
    ...
    public function testWrongUsernameLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['username'] = 'droptienda-some-user';
        $loginDetails['password'] = 'droptienda-some-pass';
    ...
    public function testWrongEmailLogin()
    {
        ...
        $loginDetails = array();
        $loginDetails['email'] = 'droptienda-some-email';
        $loginDetails['password'] = 'droptienda-some-pass';
