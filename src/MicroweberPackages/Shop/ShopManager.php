...
class ShopManager
{
    ...
    public function shipping_currency_format($amount, $curr = false)
    {
        if(is_array($amount)){
            return;
        }
    ...
    public function currency_format_no_sym($amount, $curr = false)
    {
        if(is_array($amount)){
            return;
        }
